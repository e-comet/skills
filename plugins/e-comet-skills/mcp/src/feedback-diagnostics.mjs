...
export const FEEDBACK_DIAGNOSTIC_MODULES = Object.freeze(['feedback-diagnostics.mjs', 'feedback-errors.mjs', 'feedback-tools.mjs', 'feedback-upload.mjs', 'hook-signature.mjs', 'feedback-artifact-store.mjs', 'feedback-metadata.mjs', 'feedback-report.mjs', 'feedback-zip.mjs', 'mcp-dispatcher.mjs', 'tool-schemas.mjs']);
export const FEEDBACK_DIAGNOSTIC_REASONS = Object.freeze(['claim_binding_mismatch', 'claim_signature_invalid', 'invalid_input', 'invalid_state', 'state_missing', 'storage_unavailable', 'upload_already_started', 'artifact_missing', 'artifact_expired', 'artifact_integrity', 'invalid_headers', 'network_timeout', 'internal_error', 'destination_refused', 'archive_mismatch', 'archive_shape']);
